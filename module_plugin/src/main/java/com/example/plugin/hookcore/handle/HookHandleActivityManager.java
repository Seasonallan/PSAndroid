...
package com.example.plugin.hookcore.handle;
...
import com.example.plugin.compat.ActivityManagerCompat;
import com.example.plugin.compat.Env;
import com.example.lib.reflect.FieldUtils;
import com.example.lib.reflect.MethodUtils;
import com.example.plugin.core.PluginManager;
import com.example.plugin.core.PluginManagerService;
import com.example.plugin.core.PluginProcessManager;
import com.example.plugin.stub.MyFakeIBinder;
import com.example.plugin.stub.RunningActivities;
import com.example.plugin.stub.ServcesManager;
import com.example.plugin.stub.ShortcutProxyActivity;
                        ...
                        final Runnable r = new Runnable() {
                            ...
                            public void run() {
                                try {
                                    ...
                                    LogUtil.i(TAG, "startService for PendingIntent %s", e, actionIntent);
                                }
                            }
                        };
                        ...
                        final Runnable r = new Runnable() {
                            ...
                            public void run() {
                                try {
                                    ...
                                    LogUtil.i(TAG, "startActivity for PendingIntent %s", e, actionIntent);
                                }
                            }
                        };
                        new Thread("") {
                ...
                if (activityInfo != null && isPackagePlugin(activityInfo.packageName)) {
                    ...
                    if (component != null) {
                        ...
                        try {
                            ...
                            LogUtil.w(TAG, "Set Class Loader to new Intent fail", e);
                        }
       ...
       /* public int startActivities(IApplicationThread caller, String callingPackage,
            ...
            if (VERSION.SDK_INT >= VERSION_CODES.JELLY_BEAN_MR2) {
                ...
                if (args != null && args.length > index && args[index] instanceof String) {
                    ...
                    LogUtil.w(TAG, "hook startActivities,replace callingPackage fail");
                }
                ...
                if (args != null && args.length > index && args[index] != null && args[index] instanceof Intent[]) {
                    ...
                    LogUtil.w(TAG, "hook startActivities,replace intents fail");
                }

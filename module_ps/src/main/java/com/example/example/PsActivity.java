...
import com.example.example.layout.BottomPaintLayout;
import com.example.example.layout.BottomTextLayout;
import com.example.example.layout.BottomTucengLayout;
import com.example.example.layout.BottomVipLayout;
import com.example.example.layout.PSBgColorGroup;
import com.example.example.support.MosaicUtil;
import com.example.example.video.VideoActivity;
import com.example.lib.BaseContext;
import com.example.lib.RoutePath;
import com.example.lib.bean.LayerItem;
import com.example.lib.bitmap.BitmapUtil;
import com.example.lib.dimen.ColorUtil;
import com.example.lib.gif.GifMaker;
import com.example.lib.util.LogUtil;
import com.example.lib.util.ToastUtil;
import com.example.example.layout.PopInputLayout;
import com.example.lib.bean.LayerBackground;
import com.example.lib.bean.LayerEntity;
import com.example.lib.view.ps.ILayer;
import com.example.lib.view.ps.PSLayer;
import com.example.lib.file.FileUtils;
import com.example.lib.dimen.ScreenUtils;
import com.example.lib.view.ps.PSCanvas;
import com.example.example.layout.TopDeleteLayout;
import com.example.lib.view.ps.PSCoverView;
import com.example.lib.view.ps.CustomTextView;
import com.example.lib.view.ps.CustomCanvas;

 ...
 */
package com.season.example.transfer.fileupload;
...
import com.season.example.transfer.fileupload.MultipartStream.ItemInputStream;
import com.season.example.transfer.fileupload.util.Closeable;
import com.season.example.transfer.fileupload.util.FileItemHeadersImpl;
import com.season.example.transfer.fileupload.util.LimitedInputStream;
import com.season.example.transfer.fileupload.util.Streams;
...
public abstract class FileUploadBase {
     ...
     *                             the request or storing files.
     */
    public List<FileItem> parseRequest(RequestContext ctx,  OnWebServListener mListener){
        ...
        try {
            ...
            while (iter.hasNext()) {
                ...
                fileName = ((FileItemIteratorImpl.FileItemStreamImpl) item).name; 
            ...
            e.printStackTrace();
			if(mListener != null){
				mListener.onWebFileUploadError(fileName
						, e.getMessage());
			}
        }  
        return items;
    ...
    protected String getFileName(FileItemHeaders headers) {
        String fileName = getFileName(headers.getHeader(CONTENT_DISPOSITION));
        try {
			return URLDecoder.decode(fileName, Constants.ENCODING);
		} catch (UnsupportedEncodingException e) {
    ...
    private class FileItemIteratorImpl implements FileItemIterator {
        ...
        FileItemIteratorImpl(RequestContext ctx)
            ...
            if(listener != null){
            	listener.setTotalSize(requestSize);
            }
            ...
            for (;;) {
                ...
                if (currentFieldName == null) {
                    ...
                    if (fieldName != null) {
                        ...
                        if(listener != null){
                        	listener.setPrimaryKey(fileName);
                        } 

...
import com.season.book.text.layout.AbsPatch;
import com.season.book.text.layout.Layout;
...
public class PageManager implements PatchParent{
	...
	public void init(SettingParam settingParam,int chapterSize,int requestChapterIndex){
		...
		mSizeInfo = new HtmlParser.SizeInfo((int) settingParam.getSourcePaint().getTextSize(), settingParam.getPageRect());

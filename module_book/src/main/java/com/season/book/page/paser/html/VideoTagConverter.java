...
import com.season.book.page.span.media.VoiceSpan;
...
public class VideoTagConverter implements TagHandler {
	...
	public VideoTagConverter(DataProvider dataProvider){

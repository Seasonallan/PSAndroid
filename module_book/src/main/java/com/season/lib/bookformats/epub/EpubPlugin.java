package com.season.lib.bookformats.epub;
...
import com.season.lib.bookformats.epub.paser.ContainerHandler;
import com.season.lib.bookformats.epub.paser.NAVHandler;
import com.season.lib.bookformats.epub.paser.NCXHandler;
import com.season.lib.bookformats.epub.paser.OPFHandler;
import com.season.lib.bookformats.util.IOUtil;
import com.season.lib.bookformats.util.XMLUtil;
...
import com.season.lib.bookformats.NoSupportBookFormatException;
...
public class EpubPlugin{
	...
	public void init(String secretKey) throws Exception {
		...
		if(!hadContainerfile){//没找到META-INF/container.xml文件，则认为不是正确的EPUB格式书籍
			throw new NoSupportBookFormatException(filePath + " isn't a epub epub_book file!");
		}
	}

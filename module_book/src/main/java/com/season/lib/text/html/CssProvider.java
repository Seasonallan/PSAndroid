...
import com.season.lib.text.html.css.CSSParser;
import com.season.lib.text.html.css.PropertyValue;
import com.season.lib.text.html.css.Rule;
import com.season.lib.text.html.css.Selector;
...
//	private static int count = 0;
	...
	@Override
	public List<PropertyValue> getClassInfo(List<HtmlParser.TagInfo> tagInfos) {
//		CssProvider.count++;
//		
...
//		if(rebuild && tagInfos != null && !tagInfos.isEmpty()) {
		if(tagInfos != null && !tagInfos.isEmpty()) {
			...
			//添加叶子选择器
			HtmlParser.TagInfo leaf = tagInfos.get(tagInfos.size() - 1);

package com.season.lib.text.html;
...
import com.season.lib.text.html.css.PropertyValue;
import com.season.lib.text.style.AlignSpan;
import com.season.lib.text.style.AsyncDrawableSpan;
import com.season.lib.text.style.BaseAsyncDrawableSpan;
import com.season.lib.text.style.BlockquoteSpan;
import com.season.lib.text.style.Border;
import com.season.lib.text.style.ClickAsyncDrawableSpan;
import com.season.lib.text.style.FloatSpan;
import com.season.lib.text.style.GroupsAsyncDrawableSpan;
import com.season.lib.text.style.ImgPanelBGDrawableSpan;
import com.season.lib.text.style.SpannableStringBuilder;
import com.season.lib.text.style.StyleSpan;
import com.season.lib.text.style.UrlSpna;
import com.season.lib.text.Constant;
import com.season.lib.text.LinkedList;
import com.season.lib.text.PageManager.TaskListener;
import com.season.lib.text.StyleText;
import com.season.lib.text.StyleText.Intervalo;
import com.season.lib.text.Util;
import com.season.lib.text.html.HtmlParser.HtmlContentHandler;
import com.season.lib.text.html.HtmlParser.SizeInfo;
...
public final class LeReaderHtmlParser extends HtmlParser{
	...
	protected HtmlContentHandler createHandler(ICssProvider cssProvider,
		...
		return new HtmlToSpannedConverter(cssProvider, imageGetter, parser, task, tagHandler,sizeInfo);
	}
}

final class HtmlToSpannedConverter implements HtmlContentHandler {
	private static final String TAG = LeReaderHtmlParser.TAG;
	...
	public HtmlToSpannedConverter(ICssProvider cssProvider,DataProvider imageGetter
...
//		}
	...
	private static void startImg(TagInfo tagInfo, HtmlToSpannedConverter converter) {
...
//				}
	...
	static{
		...
		mCssHandlerMap.put("background-color.xml", new CssHandler() {
			@Override
			public void handle(TagInfo tagInfo, PropertyValue propertyValue) {
		...
		mCssHandlerMap.put("border-color.xml", new CssHandler() {
			@Override
			public void handle(TagInfo tagInfo, PropertyValue propertyValue) {
				Border border = tagInfo.mStyleText.getBorder();
				if(border == null){
		...
		mCssHandlerMap.put("border-top-color.xml", new CssHandler() {
			@Override
			public void handle(TagInfo tagInfo, PropertyValue propertyValue) {
				Border border = tagInfo.mStyleText.getBorder();
				if(border == null){
		...
		mCssHandlerMap.put("border-right-color.xml", new CssHandler() {
			@Override
			public void handle(TagInfo tagInfo, PropertyValue propertyValue) {
				Border border = tagInfo.mStyleText.getBorder();
				if(border == null){
		...
		mCssHandlerMap.put("border-bottom-color.xml", new CssHandler() {
			@Override
			public void handle(TagInfo tagInfo, PropertyValue propertyValue) {
				Border border = tagInfo.mStyleText.getBorder();
				if(border == null){
		...
		mCssHandlerMap.put("border-left-color.xml", new CssHandler() {
			@Override
			public void handle(TagInfo tagInfo, PropertyValue propertyValue) {
				Border border = tagInfo.mStyleText.getBorder();
				if(border == null){
	...
	static{
		mHtmlHandlerMap.put("em", new HtmlHandler() {
			@Override
			public void handle(TagInfo tagInfo, HtmlToSpannedConverter converter) {

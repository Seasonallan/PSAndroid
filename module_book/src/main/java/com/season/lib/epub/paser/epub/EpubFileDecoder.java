package com.season.lib.epub.paser.epub;
 ...
 * @date 2013-2-21
 */
public class EpubFileDecoder extends DefaultHandler {
	...
	private static final String TAG_DC_IS_MEDIA_DECODE = "dc:is_media_file_decode";//TODO:?????
	...
	private HashMap<String, Resource> idResources;
	private HashMap<String, Resource> hrefResources;
	private ArrayList<String> mChapterIds;

	public EpubFileDecoder(String filePath){
	...
	public HashMap<String, Resource> getIdResources(){
		return idResources;
	}
	 ...
	 */
	public HashMap<String, Resource> getHrefResources() {
	...
	public void startElement(String uri, String localName, String qName,
		...
		if (localName.equalsIgnoreCase(TAG_METADATA)){
			...
			isManifest = true;
			idResources = new HashMap<String, Resource>();
			hrefResources = new HashMap<String, Resource>();
		} else if(localName.equalsIgnoreCase(TAG_ITEM)){
			if(isManifest){
				String href = attributes.getValue("href");
				String id = attributes.getValue("id");
				Resource resource = new Resource(filePath, href,id, attributes.getValue("media-type"));

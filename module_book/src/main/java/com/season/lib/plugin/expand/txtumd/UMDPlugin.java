package com.season.lib.plugin.expand.txtumd;
...
import com.season.lib.plugin.umd.IntergerUtil;
import com.season.lib.plugin.umd.UmdDataBlock;
...
public class UMDPlugin extends TxtUmdBasePlugin {
	...
	public int getCurrentChapterIndex(boolean realChapter){
		return mUmdDataBlock.getCurrentChapterIndex();
	} 
	...
	protected void resetChapterIndex(int chapterIndex) {  
		...
		mBufferLength = mUmdDataBlock.getCurrentChapterLength(chapterIndex);

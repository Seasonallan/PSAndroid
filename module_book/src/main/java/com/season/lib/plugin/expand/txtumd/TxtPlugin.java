...
import com.season.lib.plugin.text.BytesEncodingDetect;
import com.season.lib.plugin.expand.txtumd.support.ChapterControll;
...
public class TxtPlugin extends TxtUmdBasePlugin {
	...
	private void findChapters(){
	    new Thread(){
	    	public void run(){ 
	    		try {
					List<ChapterControll.Chapter> res = mChapterControll.readFile();

...
import com.example.lib.db.BookDigestsDB;
import com.example.lib.db.DigestDBHelper;
import com.example.lib.dbase.BaseDBHelper;
import com.example.lib.dbase.base.BaseDao;
import com.example.lib.dbase.base.IDbHelper;
import com.example.lib.dbase.base.iterface.Column;
import com.example.lib.dbase.base.iterface.Table;
...
public class BookDigests  extends BaseDao {
	...
	public void setBGColor(int mColor) {
		...
		mColorSpan = new ColorSpan(mColor);
	}
	...
	public void set(BookDigests bookDigests){
		if(bookDigests != null){
            ...
            this.mColorSpan = bookDigests.mColorSpan;

package com.season.lib.book.text.layout;
...
//	private int mLineCacheSize;
	...
	public Layout(StyleText styleText,SettingParam settingParam,LayoutCallback callback,PageManager.TaskListener task){
...
//		}
	...
	public interface LayoutCallback{
		public void onLayoutFinishPage(PageManager.TaskListener taskListener,Page page,int totalLength);
	}
}

...
import com.season.example.bookreader.anim.AbsVerGestureAnimController;
import com.season.example.bookreader.bookmarks.BookMark;
import com.season.example.bookreader.bookmarks.BookMarkDatas;
import com.season.example.bookreader.digests.AbsTextSelectHandler;
import com.season.example.bookreader.fragment.CatalogView;
import com.season.example.bookreader.fragment.ReaderMenuPopWin;
import com.season.example.bookreader.model.Book;
import com.season.example.bookreader.ui.ClickDetector;
import com.season.example.bookreader.view.BaseReadView;
import com.season.example.bookreader.view.EpubReadView;
import com.season.example.bookreader.view.IReaderView;
import com.season.example.bookreader.view.PullRefreshLayout;
import com.season.example.bookreader.view.ReadTxtView;
import com.season.lib.book.bookformats.BookInfo;
import com.season.lib.book.bookformats.Catalog;
import com.season.lib.book.bookformats.FormatPlugin;
import com.season.lib.book.bookformats.PluginManager;
import com.season.lib.book.os.SyncThreadPool;
...
public class BookActivity extends Activity implements
	...
	private BookActivity this_ = this;
...
//                    mCatalogView.setBookInfo(bookInfo.title, bookInfo.author);
					...
					runOnUiThread(new Runnable() {
						@Override
						public void run() {
                            mReadView = new ReadTxtView(BookActivity.this, mBook, BookActivity.this);
                         //   mReadView = new EpubReadView(BookActivity.this, mBook, BookActivity.this);

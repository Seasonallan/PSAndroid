...
import com.season.example.bookreader.anim.PageAnimController;
import com.season.example.bookreader.fragment.NotePopWin;
import com.season.example.bookreader.model.ReadSetting;
...
import com.season.lib.book.text.PageManager.PageManagerCallback;
import com.season.lib.book.text.SettingParam;
import com.season.lib.book.text.html.DataProvider;
import com.season.lib.book.text.html.HtmlParser;
import com.season.lib.book.text.html.HtmlParser.TagHandler;
import com.season.lib.book.text.html.ICssProvider;
...
//	private VoiceProgressSpan mLastVoiceProgressSpan;
	...
	public BaseReadView2(Context context) {
		super(context);
		init();
	}

	public BaseReadView2(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}
...
//		}
	...
	public void refreshView(Canvas canvas){
		if(!mPageAnimController.dispatchDrawPage(canvas, BaseReadView2.this)){

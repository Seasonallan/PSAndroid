...
public abstract class BasePopupWindow {
	...
	public BasePopupWindow(View parent) {
		this(parent, LayoutParams.WRAP_CONTENT,LayoutParams.WRAP_CONTENT);
	}
	...
	public BasePopupWindow(View parent, int lpWidth, int lpHeight) {
		...
		InteriorContentView interiorContentView = new InteriorContentView(
				getContext());
		interiorContentView.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT,LayoutParams.MATCH_PARENT));

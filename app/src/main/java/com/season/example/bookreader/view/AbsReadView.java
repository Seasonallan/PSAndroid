...
import com.season.example.bookreader.anim.AutoAnimController;
...
public abstract class AbsReadView extends View implements PageAnimController.PageCarver,ReadSetting.SettingListener {
	...
	protected static final int PADDING_LEFT = DimensionsUtil.dip2px(15, BaseApplication.getInstance());
	protected static final int PADDING_RIGHT = DimensionsUtil.dip2px(15, BaseApplication.getInstance());
	protected static final int PADDING_TOP = DimensionsUtil.dip2px(10, BaseApplication.getInstance());
	protected static final int PADDING_BOTTOM = DimensionsUtil.dip2px(8, BaseApplication.getInstance());
	protected static final int PADDING_CONTENT_TOP = DimensionsUtil.dip2px(15, BaseApplication.getInstance());
	protected static final int PADDING_CONTENT_BOTTOM = DimensionsUtil.dip2px(2, BaseApplication.getInstance());
	/** 代表初始界面*/

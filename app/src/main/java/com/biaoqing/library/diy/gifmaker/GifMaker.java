package com.biaoqing.library.diy.gifmaker;
...
import com.biaoqing.library.diy.gifmaker.extend.LZWEncoderOrderHolder;
import com.biaoqing.library.diy.gifmaker.extend.ThreadGifEncoder;
import com.biaoqing.library.diy.gifmaker.utils.Util;
import com.biaoqing.library.diy.ui.view.gif.frame.GifDecoderUtils;
      ...
      public void handleMessage(final Message msg) {
        ...
        if (msg.what == 200 && mOnGifMakerListener != null) {
          ...
          if (BuildConfig.DEBUG) {
            GifDecoderUtils singleton = GifDecoderUtils.getSingleton();
            singleton.setMovieResource(mOutputPath);
            int imageWidth = singleton.getViewWidth();
            int imageHeight = singleton.getViewHeight();
            int duration = singleton.getDuration();
            int delay = singleton.getDelay();
            Logger.d("onMakeGifPhotoGif:gif==>width:" + imageWidth + ",height:" + imageHeight
...
//  Task com.
//  biaoqing.library.diy.gifmaker.GifMaker$EncodeGifRunnable @bfddfc rejected
//  from java.util.concurrent.ThreadPoolExecutor@43c7c85[
//  Shutting down, pool
//  size =16,
//  active threads = 14, queued
//  tasks =0,
//  completed tasks = 29]
  ...
  public void addNull() {
    ...
    id++;
//        mExecutor.execute(new EncodeGifRunnable(bitmap, ));
    mHandler.sendEmptyMessage(id);
  }

...
//        }
        if (rect != null) {
            if (BuildConfig.DEBUG) {
                Logger.d("getOpviewHeightTop:" + rect.top + ",Bottom:" + rect.bottom);
                Logger.d("getOpviewHeightLeft:" + rect.left + ",right:" + rect.right);
            }
            return (int) (fixPoints[7] - fixPoints[1]);
        }
        return 0;
    ...
    public float[] bindRect(ViewGroup parent, Matrix matrix, boolean force) {
        ...
        if (BuildConfig.DEBUG) {
            Logger.d("bindRect... x= " + center[0] + "  ,y= " + center[1] + "  ,sx= " + scale[0] + "  ,sy= " + scale[1] + " ,degree=" +
                    " " + degree);
            Logger.d("bindRect... minScale0= " + minScale[0] + "  ,minScale1= " + minScale[1]);
        }

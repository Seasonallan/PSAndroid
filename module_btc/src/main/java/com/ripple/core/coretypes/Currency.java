...
public class Currency extends Hash160 {
    ...
    public static final Currency AITD = new Currency(BigInteger.ZERO.toByteArray());
    ...
    public boolean isNative() {
        return this == Currency.AITD || equals(Currency.AITD);
    }
...
//                if (!value.matches("[A-Z0-9]{3}")) {
    ...
    * usage of Currency objects, just String with "AITD" ambiguity.
    * */

...
import com.quincysx.crypto.bitcoin.bch.MoneyNetwork;
import com.quincysx.crypto.bitcoin.bch.bitcoincash.BitcoinCashAddressFormatter;
import com.quincysx.crypto.bitcoin.bch.bitcoincash.BitcoinCashAddressType;
 ...
 */
public class BCHCoinECKeyPair extends ECKeyPair {
    ...
    public static BCHCoinECKeyPair parse(Key keyPair, boolean testNet) {
        return new BCHCoinECKeyPair(keyPair, testNet);
    }

    public static BCHCoinECKeyPair parseWIF(String wif) throws ValidationException {
...
//        }
        return new BCHCoinECKeyPair(bytes, isTestNet, isCompressed);
    }

    public BCHCoinECKeyPair(byte[] p, boolean testNet, boolean compressed) throws
            ValidationException {
        super(p, compressed);
        this.testNet = testNet;
    }

    public BCHCoinECKeyPair(BigInteger priv, boolean testNet, boolean compressed) {
        super(priv, compressed);
        this.testNet = testNet;
    }

    public BCHCoinECKeyPair(Key keyPair, boolean testNet) {
        super(keyPair);
        this.testNet = testNet;
    }

    protected BCHCoinECKeyPair(BigInteger priv, boolean compressed) throws ValidationException {
        super(priv, compressed);
        this.testNet = false;
    }

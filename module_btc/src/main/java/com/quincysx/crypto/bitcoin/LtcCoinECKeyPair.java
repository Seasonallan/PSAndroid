 ...
 */
public class LtcCoinECKeyPair extends ECKeyPair {
    private static final int TEST_NET_ADDRESS_SUFFIX = 0x6f;
    private static final int MAIN_NET_ADDRESS_SUFFIX = 0x30;

    public static final int MAIN_NET_PRIVATE_KEY_PREFIX = 0xb0;
    public static final int TEST_NET_PRIVATE_KEY_PREFIX = 0x15e;
    ...
    public static LtcCoinECKeyPair parse(Key keyPair, boolean testNet) {
        return new LtcCoinECKeyPair(keyPair, testNet);
    }

    public static LtcCoinECKeyPair parseWIF(String wif) throws ValidationException {
...
//        }
        return new LtcCoinECKeyPair(bytes, isTestNet, isCompressed);
    }

    public LtcCoinECKeyPair(byte[] p, boolean testNet, boolean compressed) throws
            ValidationException {
        super(p, compressed);
        this.testNet = testNet;
    }

    public LtcCoinECKeyPair(BigInteger priv, boolean testNet, boolean compressed) {
        super(priv, compressed);
        this.testNet = testNet;
    }

    public LtcCoinECKeyPair(Key keyPair, boolean testNet) {
        super(keyPair);
        this.testNet = testNet;
    }

    protected LtcCoinECKeyPair(BigInteger priv, boolean compressed) throws ValidationException {
        super(priv, compressed);
        this.testNet = false;
    }

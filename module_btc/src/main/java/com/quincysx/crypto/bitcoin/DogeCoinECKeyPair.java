 ...
 */
public class DogeCoinECKeyPair extends ECKeyPair {
    private static final int TEST_NET_ADDRESS_SUFFIX = 0x71;
    private static final int MAIN_NET_ADDRESS_SUFFIX = 0x1e;

    public static final int MAIN_NET_PRIVATE_KEY_PREFIX = 0x9e;
    public static final int TEST_NET_PRIVATE_KEY_PREFIX = 0xf1;
    ...
    public static DogeCoinECKeyPair parse(Key keyPair, boolean testNet) {
        return new DogeCoinECKeyPair(keyPair, testNet);
    }

    public static DogeCoinECKeyPair parseWIF(String wif) throws ValidationException {
...
//        }
        return new DogeCoinECKeyPair(bytes, isTestNet, isCompressed);
    }

    public DogeCoinECKeyPair(byte[] p, boolean testNet, boolean compressed) throws
            ValidationException {
        super(p, compressed);
        this.testNet = testNet;
    }

    public DogeCoinECKeyPair(BigInteger priv, boolean testNet, boolean compressed) {
        super(priv, compressed);
        this.testNet = testNet;
    }

    public DogeCoinECKeyPair(Key keyPair, boolean testNet) {
        super(keyPair);
        this.testNet = testNet;
    }

    protected DogeCoinECKeyPair(BigInteger priv, boolean compressed) throws ValidationException {
        super(priv, compressed);
        this.testNet = false;
    }
